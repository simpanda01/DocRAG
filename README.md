...
The DocRAG  platform follows a client-server architecture with AI integration for advanced healthcare features.

![DocRAG  Architecture](./Images/DocRAG .png)
...
We welcome contributions to improve DocRAG . Please follow these steps:
...
**DocRAG ** - Your Partner in Modern Healthcare
