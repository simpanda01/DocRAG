      ...
      <header className="bg-gradient-to-r from-blue-600 to-blue-400 text-white shadow-md">
        <div className="container mx-auto py-4 px-6">
          <nav className="flex justify-between items-center">
            <div className="text-2xl font-bold">DocRAG </div>
      ...
      <main>
        <section className="bg-gradient-to-r from-blue-500 to-blue-600 text-white py-20">
          <div className="container mx-auto px-6 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Welcome to DocRAG </h1>
        ...
        <section className="bg-gradient-to-r from-blue-100 to-blue-200 py-16">
          <div className="container mx-auto px-6">
            <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Why Choose DocRAG ?</h2>
        ...
        <section className="py-16">
          <div className="container mx-auto px-6">
            ...
            <div className="text-center">
              <p className="text-xl mb-8">Experience the future of healthcare with DocRAG . Our innovative platform combines advanced technology with personalized care to provide you with the best possible health outcomes.</p>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap justify-between items-center">
            <div className="w-full md:w-1/3 text-center md:text-left mb-6 md:mb-0">
              <h3 className="text-2xl font-bold">DocRAG </h3>
          ...
          <div className="border-t border-blue-500 mt-8 pt-6 text-center">
            <p>&copy; 2024 DocRAG . All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
